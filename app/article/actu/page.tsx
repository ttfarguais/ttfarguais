...
const barenko = "https://www.barenko.com/";

  return (
    <section className="mb-16 md:w-4/6 m-auto 2xl:w-3/6">
      <div className="p-6">
        <h1 className="text-xl text-center font-bold p-4 mb-8">Les TT Farguais plus beaux que jamais !</h1>
        ...
        <p>
          La généreuse proposition de <Link href={roms} target="_blank" className="font-bold text-solid underline">Romain Hernandez</Link>, membre investi de notre club de <strong>tennis de table</strong>, de retravailler notre identité visuelle avec <Link href={barenko} className="font-bold text-solid underline">Barenko</Link> (un ami de Romain) a été
          saisie à la suite de nombreuses réunions au sein du bureau. Nous avons
          donc pris la décision de lui faire confiance.
        </p>
        <p>
          Un nouveau logo ainsi qu&apos;un nouveau site web voient ainsi le jour
        ...
        <p className="text-solid font-bold">
          Rendez-vous en septembre 2025 pour découvrir toutes ces nouveautés et
          célébrer ensemble cette nouvelle étape de notre histoire !
        </p>
        </div>
      </div>
