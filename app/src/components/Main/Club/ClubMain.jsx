...
export default function ClubMain() {
  ...
  return (
    ...
    <p className="mb-4">
      ...
      <p className="mb-4">
      A la rentrée 1993 la création d’une école de Tennis de Table s’est avérée évidente. Plusieurs titres sont remportés en jeunes et en adultes.
      </p>
      <p className="mb-4">
