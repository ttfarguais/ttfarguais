    ...
    <section className="mb-16 md:w-4/6 m-auto 2xl:w-3/6">
      <div className="p-6">
        ...
        <div className="flex flex-col justify-between mb-8 gap-6 text-justify">
          <p>
            Le <strong>T.T Farguais</strong>, notre cher club de tennis de table
            de
          ...
          <p>
            ...
            <strong>T.T Farguais</strong>. Les éclats de rire, les discussions
            animées et les sourires étaient omniprésents.
          </p>
          ...
          <p>
            ...
            des 30 ans du
            <strong> T.T Farguais </strong> a été un véritable succès. Elle nous
            a permis de renforcer nos liens, de célébrer notre histoire et de
            regarder vers l&lsquo;avenir avec optimisme et enthousiasme. Merci à
            tous ceux qui ont participé à cet événement inoubliable. Nous avons
            hâte de continuer à écrire ensemble les prochaines pages de
            l&lsquo;histoire du <strong>T.T Farguais</strong>.
          </p>
        </div>
        <div className="flex justify-around ">
          <Image
