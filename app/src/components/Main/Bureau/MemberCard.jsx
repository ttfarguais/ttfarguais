...
export default function MemberCard({membre}){
  return (
    ...
    {membre.img ? (<Image src={membre.img}
    width={500}
    height={500}
    alt={membre.alt}
    className="m-auto w-40 h-40 object-cover object-top rounded-full"/>) : <div className="m-auto w-40 h-40 bg-emerald-100 rounded-full"></div>}
